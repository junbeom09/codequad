...
const Mainpage = () => {
    ...
    const pressAgencies = [
        ...
        { id: 20, name: "연합뉴스", logo: "https://www.yonhapnewstv.co.kr/asset/img/common/img_logo_yhntv_navy.png" },
    ...
    const getCompany = async  (e) =>{
        try {
            const company = (e.target.innerText || e.target.getAttribute("alt"));
            // if(company==null){
            //    setCompany(e.target.getAttribute("alt"));
            // }
    ...
    return (
        <newjinsContext.Provider value={{ cateNews, setCateNews, cateNum, setCateNum, userInfo, setUserInfo,
            subscribedAgencies, setSubscribedAgencies, companyNews, setCompanyNews, companyName, pressAgencies}}>
                                            ...
                                            <div className="press-list-wrap">
                                                ...
                                                <ul className="press-list">
                                                    {pressAgencies.map(agency => (
                                                        <li key={agency.id}>
                                                            <NavLink to="/company" className="providerClick2">
                                                                <img loading="lazy" onClick={getCompany} style={{float: "left"}}
